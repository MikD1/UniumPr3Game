...
namespace UniumPr3Game
{
    class Game
    {
        ...
        private void PrintStatistics()
        {
            ...
            Console.WriteLine("---------------------------------");
            Console.WriteLine(string.Format("1. Воин - {0}/{1} HP", _warrior1.HP, _warrior1.MaxHP));
            Console.WriteLine(string.Format("2. Маг - {0}/{1} HP", _mage1.HP, _mage1.MaxHP));
            Console.WriteLine(string.Format("3. Жрец - {0}/{1} HP", _priest1.HP, _priest1.MaxHP));
            Console.WriteLine("=================================");
            Console.WriteLine("Команда 2:");
            Console.WriteLine("---------------------------------");
            Console.WriteLine(string.Format("1. Воин - {0}/{1} HP", _warrior2.HP, _warrior2.MaxHP));
            Console.WriteLine(string.Format("2. Маг - {0}/{1} HP", _mage2.HP, _mage2.MaxHP));
            Console.WriteLine(string.Format("3. Жрец - {0}/{1} HP", _priest2.HP, _priest2.MaxHP));
            Console.WriteLine("=================================");
        }
        private bool IsEnd()
        {
